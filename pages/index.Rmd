...
- `Lorenzo Drufuca` (anna.beneggi@ifom.eu)
...
# Credits
Some of the images and inspiration came from other tutorials available online, in particular [this work](tmp) for images and [this work](tmp) for some of the information regarding data normalization. All of the code present within this site was developed and is readily implementable in [RStudio](https://posit.co/) using [RMarkdown](https://rmarkdown.rstudio.com/) and [R](https://www.r-project.org/)>4.4.0.
