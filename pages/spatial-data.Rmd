...
In order to have everything ready to go through the exercises of the workshop, we first need to download the required materials. To do so, click on [this link](githubdownloadlink). This should trigger a fole download on your system. 
...
- Compute the percentage of reads that map to the mitochondrial genome (useful to detect stressed/dying cells)
- Compute a measure of _transcriptional complexity_ per spot, ot the total number of genes we can find per spot over the total number of spot UMIs (the two should be strongly correlated)
...
We can also plot relationships between quality metrics in the following way:
...
- Downloaded public Visium spatial data
